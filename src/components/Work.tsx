...
const experiences = [
  ...
  },
  {
    ...
    location: 'Graz, Austria',
    period: '2021-2023',
    description: 'Managed business operations, including financial planning, marketing strategies, and client relations. Workshops and Coachings in Team Development, Leadership Development and Sport Psychology',
